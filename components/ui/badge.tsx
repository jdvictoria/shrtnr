...
const badgeVariants = cva(
  "inline-flex items-center rounded-none border px-2.5 py-0.5 font-mono text-[0.68rem] font-bold uppercase tracking-[0.06em] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
